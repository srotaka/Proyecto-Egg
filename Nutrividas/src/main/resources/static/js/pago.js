...
formulario.inputNumero.addEventListener('keyup', (e) => {
    ...
    var logoMarca2 = document.getElementById("logo-marca");
    var delantera = document.getElementById("delantera");
	...
	if(valorInput == ''){
        ...
        delantera.removeAttribute("style", " background-color: #0093E9; background-image: linear-gradient(160deg, #0093E9 0%, #06192f 100%);")
	}
